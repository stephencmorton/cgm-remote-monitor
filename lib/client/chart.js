...
function init (client, d3, $) {
  ...
  chart.axisFontSize = function axisFontSize()
  {
    return Math.max(16,Math.min(6,Math.ceil(16 * chart.prevChartHeight/800)));
  }
  // create the x axis container
  chart.focus.append('g')
    .attr('class', 'x axis')
    .style("font-size", chart.axisFontSize + "px");
  ...
  chart.context.append('g')
    ...
    chart.context.append("linearGradient")
    .attr("id", "context-line-gradient")
    .attr("gradientUnits", "userSpaceOnUse")
//    .attr("x1", 0).attr("y1", 0)
//    .attr("x2", 0).attr("y2", yScale2(utils.scaleMgdl(CONTEXT_MAX)))
.selectAll("stop")
    .data([
        {offset: "0%", color: '#E94F64'}, //red
        {offset: client.settings.thresholds.bgTargetLow/utils.scaleMgdl(CONTEXT_MAX), color: '#E94F64'}, //red urgent
        {offset: client.settings.thresholds.bgTargetLow/utils.scaleMgdl(CONTEXT_MAX), color: '#E5C454'}, //yellow warning
        {offset: client.settings.thresholds.bgTargetBottom/utils.scaleMgdl(CONTEXT_MAX), color: '#E5C454'},//yellow
        {offset: client.settings.thresholds.bgTargetBottom/utils.scaleMgdl(CONTEXT_MAX), color: '#71d252'}, //green
        {offset: client.settings.thresholds.bgTargetTop/utils.scaleMgdl(CONTEXT_MAX), color: '#71d252'}, //green
        {offset: client.settings.thresholds.bgTargetTop/utils.scaleMgdl(CONTEXT_MAX), color: '#E5C454'}, // yellow warning
        {offset: client.settings.thresholds.bgTargetHigh/utils.scaleMgdl(CONTEXT_MAX), color: '#E5C454'}, // yellow warning
        {offset: client.settings.thresholds.bgTargetHigh/utils.scaleMgdl(CONTEXT_MAX), color: '#E94F64'}, //red urgent
        {offset: "100%", color: '#E94F64'}, //red urgent
    ])
    .enter().append("stop")
  ...
  chart.update = function update (init) {
    ...
    if (widthChanged || (chart.prevChartHeight !== chartHeight)) {
      ...
      if (init) {
        ...
        // add a vertical line that marks the current time
        ...
        // add a horizontal line that shows the high bg threshold
        chart.focus.append('line')
        ...
        // add a horizontal line that shows the top bg threshold
        chart.focus.append('line')
        ...
        // add a horizontal line that shows the low bottom threshold
        chart.focus.append('line')
        ...
        // add a horizontal line that shows the low bg threshold
        chart.focus.append('line')
          .attr('class', 'low-line')
          .attr('x1', chart.xScale.range()[0])
        ...
        // add a y-axis line that shows the top bg threshold
        chart.context.append('line')
          .attr('class', 'high-line')
        ...
        // add a y-axis line that shows the bottom bg threshold
        chart.context.append('line')
          .attr('class', 'low-line')
          .attr('x1', chart.xScale(dataRange[0]))
